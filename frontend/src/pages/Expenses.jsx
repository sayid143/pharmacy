...
export default function Expenses() {
    ...
    return (
        <div className="space-y-6 animate-fade-in pb-10">
            ...
            {/* List */}
            <div className="card border border-gray-100 shadow-sm rounded-xl bg-white mt-4 relative overflow-visible">
                <div className="p-4 border-b border-gray-100 flex flex-wrap gap-4 justify-between items-center bg-white rounded-t-xl overflow-visible">
                            ...
                            {showColumnFilter && (
                                <>
                                    ...
                                    <div 
                                        ...
                                        className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-100 z-40 animate-fade-in py-2"
                                    >
                    ...
                    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 animate-fade-in">
                        <div className="flex flex-col items-center text-center gap-3">
                            ...
                            <p className="text-sm text-gray-500">
                                Are you sure you want to delete <span className="font-bold text-gray-800">{deleteConfirm.category}</span> expense for <span className="font-bold text-gray-800">${Number(deleteConfirm.amount).toFixed(0)}</span>?
                            </p>
