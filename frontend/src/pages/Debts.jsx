    ...
    return (
        <div className="space-y-6 pb-10 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatCard
                    title="Paid Debts"
                    value={`ETB ${parseFloat(summary.total_paid_amount || 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`}
                    icon={CheckCircle2}
                ...
                <StatCard
                    ...
                    value={`ETB ${parseFloat(summary.total_outstanding_amount || 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`}
                    icon={Clock}
                        ...
                        <div className="px-6 pt-6">
                            <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 shadow-inner">
                                <div className="flex justify-between items-center mb-3">
                                    ...
                                    <span className="text-xl font-black text-rose-600">ETB {parseFloat(paymentModal.balance).toFixed(0)}</span>
                                </div>
                                ...
                                <div className="flex justify-between mt-2.5 items-end">
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-medium text-gray-400">Paid: ETB {parseFloat(paymentModal.paid_amount).toFixed(0)}</span>
                                        <span className="text-[10px] font-medium text-gray-400">Total: ETB {parseFloat(paymentModal.amount).toFixed(0)}</span>
                                    </div>
