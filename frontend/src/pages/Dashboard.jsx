        ...
        <div className="space-y-6 animate-fade-in pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                ...
                <StatCard
                    ...
                    value={`$${Number(stats.today_profit || 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`}
                    icon={TrendingUp}
                ...
                <StatCard
                    ...
                    value={`$${Number(stats.today_revenue || 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`}
                    icon={DollarSign}
                    color="text-blue-500"
                    bg="bg-blue-50"
                />
                <StatCard
                    title="Today's Debts"
                    value={`$${Number(stats.today_debt_amount || 0).toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}`}
                    icon={CreditCard}
                            ...
                            <tbody className="divide-y divide-gray-100 bg-white">
                                {(data?.recent_sales || []).map((sale) => (
                                    <tr key={sale.id} className="text-sm transition-colors hover:bg-gray-50/50">
                                        ...
                                        <td className="px-3 py-4 text-right font-bold text-gray-900">ETB {Number(sale.total_amount).toLocaleString(undefined, { minimumFractionDigits: 0 })}</td>
